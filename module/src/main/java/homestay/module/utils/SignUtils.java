...
import homestay.module.user.entity.UserSign;
...
public final class SignUtils {
    ...
    private final static String SIGN_SALT = "_2023_dream";
    private final static int EXPIRATION_TIME = 9999999;
    private static final String PASSWORD_SALT = "__HD_RED";
